...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.addIndex(
        'xa_activity_monitoring',
        ['employee_license', 'monitoring_date'],
        {
      ...
      await queryInterface.addIndex(
        'xa_activity_monitoring',
        ['employee_license', 'status_at_date'],
        {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      // Supprimer les index
      await queryInterface.removeIndex('xa_activity_monitoring', 'idx_activity_monitoring_guid', {
        transaction,
      });
      await queryInterface.removeIndex(
        'xa_activity_monitoring',
        'idx_activity_monitoring_employee_license',
        { transaction },
      );
      await queryInterface.removeIndex(
        'xa_activity_monitoring',
        'idx_activity_monitoring_monitoring_date',
        { transaction },
      );
      await queryInterface.removeIndex(
        'xa_activity_monitoring',
        'idx_activity_monitoring_last_punch_date',
        { transaction },
      );
      await queryInterface.removeIndex(
        'xa_activity_monitoring',
        'idx_activity_monitoring_status_at_date',
        { transaction },
      );
      await queryInterface.removeIndex(
        'xa_activity_monitoring',
        'idx_activity_monitoring_punch_count_7_days',
        { transaction },
      );
      await queryInterface.removeIndex(
        'xa_activity_monitoring',
        'idx_activity_monitoring_consecutive_absent_days',
        { transaction },
      );
      await queryInterface.removeIndex(
        'xa_activity_monitoring',
        'idx_activity_monitoring_employee_licence_monitoring_date',
        { transaction },
      );
      await queryInterface.removeIndex(
        'xa_activity_monitoring',
        'idx_activity_monitoring_employee_status',
        { transaction },
      );
