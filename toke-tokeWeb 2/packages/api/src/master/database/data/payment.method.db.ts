...
export const PaymentMethodDbStructure = {
  ...
  options: {
    ...
    indexes: [
      ...
      {
        fields: ['active'],
        name: 'idx_payment_method_is_active',
      },
      {
        fields: ['processing_fee_rate'],
        name: 'idx_payment_method_processing_fee_rate',
      },
      {
        fields: ['min_amount_usd'],
        name: 'idx_payment_method_min_amount_usd',
      },
      {
        fields: ['max_amount_usd'],
        name: 'idx_payment_method_max_amount_usd',
      },
      // {
      //   fields: ['created_at'],
      //   name: 'idx_payment_method_created_at',
      // },
    ],
  } as ModelOptions,
