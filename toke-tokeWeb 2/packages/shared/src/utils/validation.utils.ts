// shared/src/utils/validation.utils.ts
import { COUNTRY_VALIDATION } from '../constants/country.constants';
...
export class CountryValidationUtils {
    ...
    static validateCountryName(name: string): boolean {
        ...
        return trimmed.length >= COUNTRY_VALIDATION.NAME.MIN_LENGTH &&
