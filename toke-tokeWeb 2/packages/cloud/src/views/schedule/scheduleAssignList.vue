  ...
  <div>
    ...
    <div v-if="assignments.length === 0" class="content">
      <div class="empty-state">
        ...
        <p>
          Créez votre première assignation pour attribuer un emploi du temps à un utilisateur ou un groupe
        </p>
      </div>
    </div>
    ...
    <div v-else class="assignments-grid">
      ...
      >
        ...
        <div class="assignment-card-header">
          <div>
            ...
            <div class="assignment-meta">
              <span class="assignment-template">{{ assignment.session_template.name }}</span>
          ...
          <div class="assignment-status">
            <div
              class="assignment-active-dot"
              :class="{ active: assignment.active }"
              :title="assignment.active ? 'Active' : 'Inactive'"
            />
          </div>
        </div>
        ...
        <div v-if="assignment.reason" class="assignment-reason">
          ...
          <span class="reason-text">{{ assignment.reason }}</span>
        </div>
          ...
          <div class="delete-confirmation-content">
            ...
            <div class="delete-details" v-if="assignmentToDelete">
              ...
              <ul class="delete-list">
                <li>Emploi du temps: {{ assignmentToDelete.session_template.name }}</li>
                <li>Période: {{ formatDate(assignmentToDelete.start_date) }} - {{ formatDate(assignmentToDelete.end_date) }}</li>
                <li v-if="assignmentToDelete.reason">Raison: {{ assignmentToDelete.reason }}</li>
                <li>Statut: {{ assignmentToDelete.active ? 'Active' : 'Inactive' }}</li>
              </ul>
            </div>
...
import { ref } from "vue";
import { User, Group } from '@/service/GroupService';
...
const emit = defineEmits<{
  edit: [assignment: ScheduleAssignment];
  "view-details": [assignment: ScheduleAssignment];
...
const assignmentToDelete = ref<ScheduleAssignment | null>(null);
const showDeleteConfirm = ref(false);

function confirmDelete(assignment: ScheduleAssignment) {
...
/* Modal styles (similaires à rotationList.vue) */
.modal-overlay {
  position: fixed;
  top: 0;
  left: 0;
...
<!--    &lt;!&ndash; Liste des assignations &ndash;&gt;-->
<!--    <div v-else class="assignments-grid">-->
<!--      <div-->
<!--        v-for="assignment in assignments"-->
<!--        :key="assignment.guid"-->
...
<!--        &lt;!&ndash; Détails utilisateur/groupe &ndash;&gt;-->
<!--        <div class="assignment-target-info">-->
<!--          <div v-if="assignment.user" class="target-details">-->
<!--            <div class="target-avatar">-->
<!--              {{ getInitials(assignment.user.first_name, assignment.user.last_name) }}-->
...
<!--        &lt;!&ndash; Raison (si présente) &ndash;&gt;-->
<!--        <div v-if="assignment.reason" class="assignment-reason">-->
<!--          <span class="reason-label">📝 Raison:</span>-->
<!--          <span class="reason-text">{{ assignment.reason }}</span>-->
<!--        </div>-->

<!--        &lt;!&ndash; Informations additionnelles &ndash;&gt;-->
<!--        <div class="assignment-info">-->
<!--          <div class="info-item">-->
<!--            <span class="info-label">Créé par:</span>-->
<!--            <span class="info-value">-->
