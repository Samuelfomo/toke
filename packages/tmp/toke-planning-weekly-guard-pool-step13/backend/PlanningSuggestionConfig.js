...
class PlanningSuggestionConfig extends PlanningSuggestionConfigModel_js_1.default {
            ...
            return {
                ...
                rules: {
                    ...
                    guard_team_policy: {
                        ...
                        rotation_anchor_date: (_d = this.guard_team_rotation_anchor_date) !== null && _d !== void 0 ? _d : null,
    ...
    hydrate(data) {
        ...
        this.guard_team_mode =
            (_q = data.guard_team_mode) !== null && _q !== void 0 ? _q : 'DAILY_FLEXIBLE';
        this.guard_team_employees_per_week =
            (_r = data.guard_team_employees_per_week) !== null && _r !== void 0 ? _r : 1;
        this.guard_team_selection_mode =
            (_s = data.guard_team_selection_mode) !== null && _s !== void 0 ? _s : 'ROTATION_ORDER';
        this.guard_team_rotation_anchor_date =
            (_t = data.guard_team_rotation_anchor_date) !== null && _t !== void 0 ? _t : null;
        this.guard_team_complete_weeks_only =
            (_u = data.guard_team_complete_weeks_only) !== null && _u !== void 0 ? _u : true;
        this.guard_team_require_participation =
            (_v = data.guard_team_require_participation) !== null && _v !== void 0 ? _v : true;
        this.fairness_window_weeks = (_w = data.fairness_window_weeks) !== null && _w !== void 0 ? _w : 8;
        this.strict_coverage = (_x = data.strict_coverage) !== null && _x !== void 0 ? _x : true;
        this.solver_type =
            (_y = data.solver_type) !== null && _y !== void 0 ? _y : 'GREEDY';
        this.solver_timeout_seconds =
            (_z = data.solver_timeout_seconds) !== null && _z !== void 0 ? _z : 20;
        this.fallback_to_greedy =
            (_0 = data.fallback_to_greedy) !== null && _0 !== void 0 ? _0 : true;
        this.created_by = data.created_by;
        this.deleted_at = (_1 = data.deleted_at) !== null && _1 !== void 0 ? _1 : null;
