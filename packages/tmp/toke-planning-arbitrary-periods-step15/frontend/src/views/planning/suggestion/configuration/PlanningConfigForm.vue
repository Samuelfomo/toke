<template>
  <PlanningDrawer
      ...
      description="Les politiques sont génériques et s’appliquent uniquement aux populations et services sélectionnés."
      @close="$emit('close')"
  >
    <div class="space-y-7">
      ...
      <section class="rounded-2xl border border-rose-100 bg-rose-50/30 p-4">
          ...
          >
            <div class="flex items-start justify-between gap-3">
              <div>
                ...
                <p class="mt-1 text-[10px] leading-4 text-slate-500">{{ policy.description }}</p>
              </div>
              <IconCircleCheck
        ...
        <div
            ...
            class="mt-4 space-y-5 rounded-xl border border-fuchsia-100 bg-white p-4"
        >
          <div class="rounded-xl border border-fuchsia-100 bg-fuchsia-50/60 px-4 py-3">
            <p class="text-xs font-bold text-fuchsia-900">Politique avancée par employé éligible</p>
            <p class="mt-1 text-[11px] leading-5 text-fuchsia-800/80">
          ...
          <section class="rounded-xl border border-slate-200 p-4">
            ...
            <div class="mt-3 grid gap-4 sm:grid-cols-2">
              <div>
                <p class="text-[11px] font-bold text-slate-700">Modes de planning</p>
              ...
              <div>
                <label class="text-[11px] font-bold text-slate-700">Relation avec le pool de garde</label>
          ...
          <section class="rounded-xl border border-slate-200 p-4">
            ...
            <div class="mt-3 grid gap-2 sm:grid-cols-2">
              ...
              >
                ...
                <p class="mt-1 text-[10px] leading-4 text-slate-500">{{ scope.description }}</p>
              </button>
            </div>
...
const policyOptions = [
  ...
  },
  {
    ...
    activeClass: 'border-fuchsia-300 bg-fuchsia-50 ring-2 ring-fuchsia-100',
  },
]
      ...
      h(
          'button',
          {
            ...
            class: [
              ...
              props.checked ? 'border-indigo-300' : 'border-slate-200',
            ],
            onClick: () => emit('toggle'),
          },
          [
            ...
            h('span', {}, [
              ...
              h('span', { class: 'mt-1 block text-[10px] leading-4 text-slate-500' }, props.description),
            ]),
          ],
      )
  },
      ...
      h('div', {}, [
        h('div', { class: 'flex flex-wrap items-center justify-between gap-2' }, [
          h('div', {}, [
            ...
            h('p', { class: 'mt-1 text-[11px] text-slate-500' }, 'Le moteur choisit uniquement parmi ces jours.'),
          ]),
      ...
      h('div', { class: 'space-y-3' }, [
        h('div', { class: 'flex items-center justify-between rounded-xl border border-slate-200 bg-slate-50 p-4' }, [
          h('div', {}, [
            ...
            h('p', { class: 'mt-1 text-[11px] text-slate-500' }, 'Les périodes partielles ne forcent pas cette politique.'),
          ]),
          h(PlanningToggle, {
        ...
        h('div', { class: 'flex items-center justify-between rounded-xl border border-slate-200 bg-slate-50 p-4' }, [
          h('div', {}, [
            ...
            h('p', { class: 'mt-1 text-[11px] text-slate-500' }, 'Désactivé : le repos métier reste distinct de la récupération.'),
          ]),
          h(PlanningToggle, {
