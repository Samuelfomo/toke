...
export default class PlanningSuggestionConfig extends PlanningSuggestionConfigModel {
  ...
  getPolicySchemaVersion(): number { return this.policy_schema_version; }
  getWeeklyLeaveSelector(): PlanningEmployeePolicySelector {
    return { ...this.weekly_leave_selector, planning_modes: [...this.weekly_leave_selector.planning_modes] };
  }
  getWeeklyLeaveDaysPerEmployee(): number { return this.weekly_leave_days_per_employee; }
  getWeeklyLeaveCountMode(): PlanningWeeklyLeaveCountMode { return this.weekly_leave_count_mode; }
  ...
  setGuardTeamSelectionMode(
    value: PlanningGuardTeamSelectionMode,
  ): this {
    ...
    return {
      ...
      rules: {
        ...
        guard_team_policy: {
          ...
          eligible_planning_modes:
            this.getGuardTeamEligiblePlanningModes(),
          member_service_access:
            this.guard_team_member_service_access,
          balance: {
            mode: this.guard_team_balance_mode,
            max_membership_spread:
  ...
  hydrate(data: any): PlanningSuggestionConfig {
    ...
    this.guard_team_mode =
      data.guard_team_mode ?? 'DAILY_FLEXIBLE';
    this.guard_team_employees_per_week =
      data.guard_team_employees_per_week ?? 1;
    this.guard_team_selection_mode =
    ...
    this.guard_team_complete_weeks_only =
      data.guard_team_complete_weeks_only ?? true;
    this.guard_team_require_participation =
      data.guard_team_require_participation ?? true;
    this.guard_team_eligible_planning_modes =
      data.guard_team_eligible_planning_modes ?? ['ROTATING'];
    this.guard_team_member_service_access =
      data.guard_team_member_service_access ?? 'ANY_SERVICE';
