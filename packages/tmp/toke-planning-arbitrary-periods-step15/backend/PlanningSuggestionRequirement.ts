...
export default class PlanningSuggestionRequirement extends PlanningSuggestionRequirementModel {
  ...
  static _load(
    ...
    return new PlanningSuggestionRequirement().load(
      identifier,
      byGuid,
    );
  }
  ...
  static _listByConfig(
    ...
    return new PlanningSuggestionRequirement().listByConfig(
      configId,
      activeOnly,
    );
  }
  ...
  getEligibilityPolicy(): PlanningRequirementEligibilityPolicy {
    return {
  ...
  setEligibilityPolicy(value: PlanningRequirementEligibilityPolicy): this {
  ...
  async getConfigObj(): Promise<PlanningSuggestionConfig | null> {
    ...
    const config =
      await PlanningSuggestionConfig._load(this.config);
  ...
  async getSessionTemplateObj(): Promise<SessionTemplate | null> {
    ...
    const template =
      await SessionTemplate._load(this.session_template);
  ...
  async getContinuationTemplateObj(): Promise<SessionTemplate | null> {
    ...
    const template =
      await SessionTemplate._load(this.continuation_template);
  ...
  async toJSON(): Promise<object> {
    ...
    const continuationTemplate =
      await this.getContinuationTemplateObj();
  ...
  hydrate(data: any): PlanningSuggestionRequirement {
    ...
    this.eligibility_policy = data.eligibility_policy ?? {
  ...
  private async listByConfig(
    ...
    const dataset =
      await this.listAllByConfig(configId, activeOnly);
    ...
    return dataset.map((data) =>
      new PlanningSuggestionRequirement().hydrate(data),
    );
  }
}
