...
exports.PlanningSuggestionRequirementDbStructure = void 0;
 ...
 */
exports.PlanningSuggestionRequirementDbStructure = {
    ...
    attributes: {
        ...
        config: {
            ...
            allowNull: false,
            references: {
                model: response_model_js_1.tableName.PLANNING_SUGGESTION_CONFIG,
                key: 'id',
            },
        ...
        session_template: {
            ...
            allowNull: false,
            references: {
                model: response_model_js_1.tableName.SESSION_TEMPLATES,
                key: 'id',
            },
            validate: { isInt: true, min: 1 },
        ...
        day_of_week: {
            type: sequelize_1.DataTypes.ENUM('Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'),
            allowNull: false,
            comment: 'Recurring weekday',
        },
        service_type: {
            type: sequelize_1.DataTypes.ENUM('STANDARD', 'GUARD'),
            allowNull: false,
            defaultValue: 'STANDARD',
            comment: 'Controls standard or two-part guard behavior',
        },
        allocation_mode: {
            type: sequelize_1.DataTypes.ENUM('EXACT', 'RANGE', 'FILL_REMAINING'),
            allowNull: false,
            defaultValue: 'RANGE',
            comment: 'EXACT: strict count; RANGE: fill to target; FILL_REMAINING: assign every remaining eligible rotating employee',
        },
        min_employees: {
            type: sequelize_1.DataTypes.INTEGER,
            allowNull: false,
        ...
        eligibility_policy: {
            ...
            comment: 'Employee population allowed to satisfy this requirement',
        },
        deleted_at: {
    ...
    options: {
        ...
        indexes: [
            ...
            },
            {
                ...
                name: 'idx_planning_requirement_slot_population_lookup',
                where: { active: true, deleted_at: null },
            },
            {
                fields: ['config', 'day_of_week', 'allocation_mode'],
                name: 'idx_planning_requirement_fill_population_lookup',
                where: {
                    active: true,
                    deleted_at: null,
        ...
        validate: {
            employeeCountsAreValid() {
                ...
                const max = this.max_employees === null || this.max_employees === undefined
                    ? null
            ...
            allocationConfigurationIsValid() {
                var _a;
                const mode = (_a = this.allocation_mode) !== null && _a !== void 0 ? _a : 'RANGE';
                const min = Number(this.min_employees);
                const target = Number(this.target_employees);
                const max = this.max_employees === null ||
