...
export const PlanningSuggestionConfigDbStructure = {
  ...
  attributes: {
    ...
    weekly_leave_mode: {
      type: DataTypes.ENUM('NONE', 'PER_EMPLOYEE', 'TEAM_ROTATION', 'PER_ELIGIBLE_EMPLOYEE'),
      allowNull: false,
    ...
    weekly_leave_count_mode: {
      type: DataTypes.ENUM('MINIMUM', 'EXACT'),
      allowNull: false,
      defaultValue: 'EXACT',
    },
    ...
    guard_team_mode: {
      type: DataTypes.ENUM('DAILY_FLEXIBLE', 'WEEKLY_POOL'),
      allowNull: false,
    ...
    guard_team_selection_mode: {
      type: DataTypes.ENUM('ROTATION_ORDER', 'OPTIMIZED'),
      allowNull: false,
    ...
    guard_team_member_service_access: {
      type: DataTypes.ENUM('ANY_SERVICE', 'GUARD_ONLY'),
      allowNull: false,
      defaultValue: 'ANY_SERVICE',
    },
    guard_team_balance_mode: {
      type: DataTypes.ENUM('NONE', 'SOFT', 'STRICT'),
      allowNull: false,
      defaultValue: 'NONE',
    },
