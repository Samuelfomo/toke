...
//         details: error.issues,
//       });
//     } else if (error.message.includes('DUPLICATE_HIERARCHY')) {
//       return R.handleError(res, HttpStatus.CONFLICT, {
//         code: ORG_HIERARCHY_CODES.DUPLICATE_HIERARCHY,
...
//     if (!hierarchyObj) {
//       return R.handleError(res, HttpStatus.NOT_FOUND, {
//         code: ORG_HIERARCHY_CODES.HIERARCHY_NOT_FOUND,
...
//
//     if (validatedData.subordinate_guid) {
//       const subordinateObj = await User._load(validatedData.subordinate_guid, true);
//       if (!subordinateObj) {
//         return R.handleError(res, HttpStatus.NOT_FOUND, {
//           code: USERS_CODES.USER_NOT_FOUND,
//           message: 'Subordinate user not found',
...
//     }
//
//     if (validatedData.supervisor_guid) {
//       const supervisorObj = await User._load(validatedData.supervisor_guid, true);
//       if (!supervisorObj) {
//         return R.handleError(res, HttpStatus.NOT_FOUND, {
//           code: USERS_CODES.USER_NOT_FOUND,
//           message: 'Supervisor user not found',
