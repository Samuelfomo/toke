...
exports.ExchangeRateDbStructure = void 0;
const sequelize_1 = require("sequelize");
const response_model_js_1 = require("../../../utils/response.model.js");
exports.ExchangeRateDbStructure = {
    tableName: response_model_js_1.tableName.EXCHANGE_RATE,
    attributes: {
        id: {
        ...
        from_currency_code: {
            ...
            allowNull: false,
            references: {
                model: response_model_js_1.tableName.CURRENCY,
                key: 'code',
            },
            // onUpdate: 'CASCADE',
