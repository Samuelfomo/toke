...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.createTable('xa_fraud_detection_log', {
        id: {
      ...
      await queryInterface.addIndex('xa_fraud_detection_log', ['tenant', 'detection_type', 'risk_level'], {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeIndex('xa_fraud_detection_log', 'idx_fraud_detection_log_resolved_at', { transaction });
      await queryInterface.removeIndex('xa_fraud_detection_log', 'idx_fraud_detection_log_created_at', { transaction });
      await queryInterface.removeIndex('xa_fraud_detection_log', 'idx_fraud_detection_log_tenant_type_risk', { transaction });
