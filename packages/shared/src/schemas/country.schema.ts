// shared/src/schemas/country.schema.ts
import { z } from 'zod';
import { COUNTRY_VALIDATION, COUNTRY_DEFAULTS, COUNTRY_ERRORS } from '../constants/country.constants';
...
const baseCountrySchema = z.object({
    ...
    active: z
        .boolean()
        .default(COUNTRY_DEFAULTS.ACTIVE),
...
export const paginationSchema = z.object({
    offset: z
        ...
        .int()
        .min(0)
        .default(COUNTRY_DEFAULTS.PAGINATION.OFFSET),
    limit: z
        .number()
        .int()
        .min(1)
...
export const countryResponseSchema = apiResponseSchema(countrySchema);
