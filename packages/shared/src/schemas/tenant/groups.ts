...
const groupsWithValidation = baseGroupSchema
  .refine(
    (data) => {
...
// export const validateMemberAddition = (groupsMembers: any[], newMember: any) => {
//   // Vérifier si l'utilisateur existe déjà
//   const existingMember = groupsMembers.find((m) => m.user === newMember.user);
//   if (existingMember) {
//     const error: any = new Error(GROUPS_ERRORS.MEMBER_DUPLICATE);
//     error.code = GROUPS_CODES.MEMBER_DUPLICATE;
//     throw error;
//   }
//
//   // Valider le nouveau membre
