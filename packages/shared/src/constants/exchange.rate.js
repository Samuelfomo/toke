...
exports.EXCHANGE_RATE_ERRORS = exports.EXCHANGE_RATE_DEFAULTS = exports.EXCHANGE_RATE_VALIDATION = void 0;
exports.EXCHANGE_RATE_VALIDATION = {
    FROM_CURRENCY_CODE: {
        MIN_LENGTH: 3,
        MAX_LENGTH: 3,
        PATTERN: /^[A-Z]{3}$/,
...
exports.EXCHANGE_RATE_DEFAULTS = {
    CURRENT: true,
    PAGINATION: {
        OFFSET: 0,
        LIMIT: 50,
...
exports.EXCHANGE_RATE_ERRORS = {
    ...
    EXCHANGE_RATE_INVALID: `Exchange rate must be between ${exports.EXCHANGE_RATE_VALIDATION.EXCHANGE_RATE.MIN_VALUE} and ${exports.EXCHANGE_RATE_VALIDATION.EXCHANGE_RATE.MAX_VALUE}`,
