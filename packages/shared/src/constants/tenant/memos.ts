...
export const MEMOS_CODES = {
  ...
  RESPONSE_USER_REQUIRED: 'response_user_required',
  RESPONSE_USER_INVALID: 'response_user_invalid',
...
export const MEMOS_ERRORS = {
  ...
  DESCRIPTION_REQUIRED: `${MEMOS_LABEL} description is required (context of the request)`,
  DESCRIPTION_INVALID: `Memo description must be at least ${MEMOS_VALIDATION.DESCRIPTION.MIN_LENGTH} characters`,

  RESPONSE_USER_REQUIRED: `Employee response is required`,
  RESPONSE_USER_INVALID: `Employee response must be at least ${MEMOS_VALIDATION.RESPONSE_USER.MIN_LENGTH} characters`,
  ...
  VALIDATOR_COMMENTS_REQUIRED: 'Validator comments are required when validating or rejecting',
