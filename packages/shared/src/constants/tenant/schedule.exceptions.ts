...
export const SCHEDULE_EXCEPTION_CODES = {
  ...
  USER_OR_GROUP_REQUIRED: 'user_or_group_required',
  BOTH_USER_AND_GROUP: 'both_user_and_group',
...
export const SCHEDULE_EXCEPTION_ERRORS = {
  ...
  GROUP_INVALID: `Group GUID must be between ${SCHEDULE_EXCEPTION_VALIDATION.GROUP.MIN_LENGTH} and ${SCHEDULE_EXCEPTION_VALIDATION.GROUP.MAX_LENGTH} characters`,
  GROUP_NOT_FOUND: 'Rotation Group not found',

  USER_OR_GROUP_REQUIRED: 'Either user or group must be specified',
  BOTH_USER_AND_GROUP: 'Cannot specify both user and group',
