    ...
    <div class="employee-main" @click="openEmployeeDetails">
      ...
      <div class="employee-info">
        ...
        <div class="employee-status">
          ...
          <svg
            v-else-if="employee.status === 'absent'"
            class="icon-xs"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          ...
          <svg
            v-else-if="employee.status === 'late'"
            class="icon-xs"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          ...
          <svg
            v-else-if="employee.status === 'info'"
            class="icon-xs"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
            <path
              ...
              stroke-linejoin="round"
              stroke-width="2"
              d="M8 7V3a2 2 0 012-2h4a2 2 0 012 2v4m-6 0h6m-6 0l-1.5 8.5A2 2 0 009.5 21h5a2 2 0 002-1.5L15 12"
            ></path>
          </svg>
