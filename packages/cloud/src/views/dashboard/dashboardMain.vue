...
const loading        = ref<boolean>(true)   // premier chargement uniquement (plein écran)
const refreshing     = ref<boolean>(false)  // rechargements suivants (filtre changé) — n'affecte pas le montage du Hero
...
const loadDashboardData = async (startDate?: string, endDate?: string) => {
  const isInitialLoad = !dashboardData.value
...
<template>
  <div class="min-h-screen flex flex-col bg-gradient-to-br from-[#9cbdf6] via-[#f5f9ff] to-[#dbcdef]">
    ...
    <main class="flex-1 max-w-screen-2xl mx-auto px-4 sm:px-6 py-6 space-y-4">
      ...
      <!-- ══════════ ERREUR (bloquante, uniquement si aucune donnée déjà chargée) ══════════ -->
      <div
      ...
      <!-- ══════════ CONTENU PRINCIPAL — reste monté pendant les rechargements de filtre ══════════ -->
...
<!--<template>-->
<!--  <div class="min-h-screen flex flex-col bg-gradient-to-br from-[#9cbdf6] via-[#f5f9ff] to-[#dbcdef]">-->
<!--&lt;!&ndash;  <div class="min-h-screen bg-gradient-to-br from-[#9cbdf6] via-[#e0daf6] to-[#dbcdef]">&ndash;&gt;-->
<!--    <Header />-->
...
<!--        &lt;!&ndash; 1. Hero : titre + filtre période + 6 KPI cards + bannière anomalie &ndash;&gt;-->
<!--        <DashboardHero-->
<!--            :summary="dashboardData.summary"-->
<!--            :date="dashboardData.date"-->
<!--            :employees="employeesForFilter"-->
...
<!--        &lt;!&ndash; 2. Stats : doughnut répartition + line chart évolution + absents + anomalies &ndash;&gt;-->
<!--        <DashboardStats-->
<!--            :summary="dashboardData.summary"-->
<!--            :employees="dashboardData.employees"-->
<!--            :daily-breakdown="dashboardData.daily_breakdown"-->
...
<!--        &lt;!&ndash; 3. Grille principale : Équipe (tableau) à gauche + Timeline à droite &ndash;&gt;-->
<!--        <div class="grid grid-cols-1 xl:grid-cols-3 gap-4">-->

<!--          &lt;!&ndash; Tableau équipe : 2/3 de la largeur &ndash;&gt;-->
<!--          <div class="xl:col-span-2">-->
<!--            <EmployeeList-->
<!--                :employees="displayedEmployees"-->
<!--                @employee-click="handleEmployeeClick"-->
...
<!--          &lt;!&ndash; Timeline des arrivées : 1/3 de la largeur &ndash;&gt;-->
<!--          <div class="xl:col-span-1">-->
<!--            <AttendanceTimeline-->
<!--                :employees="dashboardData.employees"-->
<!--                :days-back="isAnalyticsMode ? periodDays : 7"-->
...
<!--        &lt;!&ndash; 4. Insights rapides (Insights panel) &ndash;&gt;-->
<!--        <div class="bg-white border border-slate-200 rounded-md p-5 shadow-sm">-->
<!--          <div class="mb-4">-->
<!--            <h4 class="text-sm font-bold text-slate-800">Insights rapides</h4>-->
<!--            <p class="text-xs text-slate-400 mt-0.5">Résumé des points d'attention sur la période</p>-->
...
<!--            &lt;!&ndash; Insight 1 : Anomalies &ndash;&gt;-->
<!--            <div class="flex items-start gap-3 p-3 rounded-xl bg-slate-50">-->
<!--              <div class="w-7 h-7 rounded-lg flex items-center justify-center shrink-0"-->
<!--                   :class="(dashboardData.summary.total_anomaly_off_days ?? 0) > 0-->
<!--                     ? 'bg-orange-100 text-orange-600'-->
...
<!--            &lt;!&ndash; Insight 3 : Couverture &ndash;&gt;-->
<!--            <div class="flex items-start gap-3 p-3 rounded-xl bg-slate-50">-->
<!--              <div class="w-7 h-7 rounded-lg bg-blue-100 text-blue-600-->
<!--                          flex items-center justify-center shrink-0">-->
<!--                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"-->
...
<!--            &lt;!&ndash; Insight 4 : Absences critiques &ndash;&gt;-->
<!--            <div class="flex items-start gap-3 p-3 rounded-xl bg-slate-50">-->
<!--              <div class="w-7 h-7 rounded-lg flex items-center justify-center shrink-0"-->
<!--                   :class="dashboardData.summary.total_absences > 0-->
<!--                     ? 'bg-red-100 text-red-600'-->
...
<!--&lt;!&ndash;        &lt;!&ndash; 5. Détail pointage employé sélectionné (panel latéral conditionnel) &ndash;&gt;&ndash;&gt;-->
<!--&lt;!&ndash;        <transition name="slide-up">&ndash;&gt;-->
<!--&lt;!&ndash;          <div&ndash;&gt;-->
<!--&lt;!&ndash;              v-if="selectedEmployee"&ndash;&gt;-->
<!--&lt;!&ndash;              class="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-slate-200&ndash;&gt;-->
<!--&lt;!&ndash;                   shadow-2xl rounded-t-2xl max-h-[70vh] overflow-y-auto&ndash;&gt;-->
<!--&lt;!&ndash;                   xl:static xl:rounded-2xl xl:shadow-sm xl:border xl:max-h-none xl:overflow-visible"&ndash;&gt;-->
<!--&lt;!&ndash;          >&ndash;&gt;-->
<!--&lt;!&ndash;            <EmployeeViewPointage&ndash;&gt;-->
<!--&lt;!&ndash;                :employees="displayedEmployees"&ndash;&gt;-->
<!--&lt;!&ndash;                :selected-employee="selectedEmployee as any"&ndash;&gt;-->
<!--&lt;!&ndash;                @employee-click="handleEmployeeClick"&ndash;&gt;-->
<!--&lt;!&ndash;                @close="closeEmployeePanel"&ndash;&gt;-->
<!--&lt;!&ndash;            />&ndash;&gt;-->
<!--&lt;!&ndash;          </div>&ndash;&gt;-->
