      ...
      <!-- Items -->
        <div v-else class="flex-1 overflow-y-auto space-y-2 bg-gray-50 max-h-[460px]">
          <div
              ...
              :class="[
                 'flex items-start gap-3 px-3 py-3 cursor-pointer border-l-2 transition-colors rounded-md',
          ...
          <div class="flex-1 min-w-0">
            <div class="flex items-start justify-between gap-1 mb-0.5">
              <span v-if="!memo.isRead" class="w-2 h-2 rounded-full bg-blue-600 flex-shrink-0"></span>
              <span :class="[ 'text-xs truncate', !memo.isRead ? 'font-bold text-gray-900' : 'font-medium text-gray-600']">
                {{ memo.titre }}
              </span>
