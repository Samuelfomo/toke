...
<!--            &lt;!&ndash; Affichage du destinataire si pas vue employé spécifique &ndash;&gt;-->
<!--&lt;!&ndash;            <div v-if="!isEmployeeSpecific" class="memo-recipient">&ndash;&gt;-->
<!--&lt;!&ndash;              <div class="recipient-avatar">&ndash;&gt;-->
<!--&lt;!&ndash;                {{ getEmployeeInitials(memo.employeeId) }}&ndash;&gt;-->
<!--&lt;!&ndash;              </div>&ndash;&gt;-->
<!--&lt;!&ndash;              <span class="recipient-name">{{ getEmployeeName(memo.employeeId) }}</span>&ndash;&gt;-->
<!--&lt;!&ndash;            </div>&ndash;&gt;-->
<!--          </div>-->
