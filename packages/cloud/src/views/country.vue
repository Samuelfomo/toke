    ...
    <div class="flex flex-col w-full">
      ...
      >
        <svg
          aria-hidden="true"
          role="status"
          class="w-32 h-32 text-gray-200 animate-spin dark:text-gray-600"
          viewBox="0 0 100 101"
          fill="none"
      ...
      <div class="flex-grow flex">
        <main class="flex-grow bg-neutral-100 lg:pl-32 lg:p-16 py-6 w-full space-y-6">
          ...
          <div
            v-if="hasCountries"
            class="flex items-center justify-between bg-white px-6 py-3 rounded-lg shadow-md"
          >
            <div class="flex items-center text-sm text-gray-700">
              <span> Page {{ currentPage }} • {{ state.pagination.count }} résultats </span>
            </div>
