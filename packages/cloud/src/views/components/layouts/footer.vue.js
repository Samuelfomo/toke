...
const openImediatis = () => {
    window.open('https://imediatis.cm', 'blank');
};
const openFacebook = () => {
    window.open('https://web.facebook.com/imediatisltd', 'blank');
};
...
__VLS_asFunctionalElement(__VLS_elements.footer, __VLS_elements.footer)({
    ...{ class: "bg-white border-t border-gray-200 z-30 py-6" },
});
...
__VLS_asFunctionalElement(__VLS_elements.a, __VLS_elements.a)({
    ...{ onClick: (__VLS_ctx.openImediatis) },
...
__VLS_asFunctionalElement(__VLS_elements.a, __VLS_elements.a)({
    ...{ onClick: (__VLS_ctx.openFacebook) },
    href: "#",
