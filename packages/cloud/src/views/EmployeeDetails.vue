      ...
      <div class="ed-profile-header">
        <div class="ed-avatar-wrapper">
          <img
              ...
              :src="employee.avatar"
              :alt="employee.name"
              class="ed-avatar ed-avatar-img"
              style="border-width: 3px; border-style: solid"
              :style="employeePhotoStyle(employee.employeeColor)"
          >
          <div
              v-else
              class="ed-avatar"
              style="border-width: 3px; border-style: solid"
              :style="employeeAvatarStyle(employee.employeeColor)"
          >
            {{ employee.initials }}
          </div>
        </div>
...
import { employeeAvatarStyle, employeePhotoStyle } from '@/utils/employeeColor'
  ...
  try {
    ...
    if (foundEmployee) {
      ...
      employee.value = {
        ...
        employeeColor: foundEmployee.employeeColor,
        initials: initials,
...
<!--      <div class="ed-actions">-->
<!--&lt;!&ndash;        <button class="ed-btn ed-btn-primary" @click="openMemoChat">&ndash;&gt;-->
<!--&lt;!&ndash;          <IconMessage class="ed-btn-icon" /> Envoyer un mémo&ndash;&gt;-->
<!--&lt;!&ndash;        </button>&ndash;&gt;-->
<!--&lt;!&ndash;        <button class="ed-btn ed-btn-secondary" @click="editEmployee">&ndash;&gt;-->
<!--&lt;!&ndash;          <IconEdit class="ed-btn-icon" /> Modifier les informations&ndash;&gt;-->
<!--&lt;!&ndash;        </button>&ndash;&gt;-->
<!--      </div>-->
<!--    </div>-->
<!--  </div>-->
