...
<template>
  <section id="attendance-kpis" aria-labelledby="attendance-kpis-title">
    <div class="mb-3 flex flex-col gap-1 sm:flex-row sm:items-end sm:justify-between">
      <div>
        <p class="text-xs font-semibold uppercase tracking-[0.14em] text-indigo-600">Vue décisionnelle</p>
        <h2 id="attendance-kpis-title" class="mt-1 text-lg font-bold text-slate-950">Ce qu’il faut comprendre maintenant</h2>
      </div>
      <p class="max-w-2xl text-sm text-slate-500">Cliquez sur une carte pour comprendre la valeur puis accéder aux personnes ou anomalies concernées.</p>
    </div>
