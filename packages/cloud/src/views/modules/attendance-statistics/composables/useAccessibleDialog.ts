...
export interface AccessibleDialogOptions {
    ...
    /**
     * Action exécutée lorsqu'une fermeture explicite est autorisée.
     */
    close: () => void;

    /**
     * Autorise ou non la fermeture avec la touche Échap.
     * Par défaut : true afin de préserver le comportement des dialogues existants.
     */
    closeOnEscape?: boolean;
}

/**
 * Gestion réutilisable d'un dialogue :
 * focus initial, piège Tab, restauration du focus
 * et verrouillage du scroll de la page.
 */
export function useAccessibleDialog(
    ...
    function handleKeydown(event: KeyboardEvent): void {
        ...
        /*
         * Fermeture avec Échap uniquement lorsque le dialogue
