...
function toDayRow(
    ...
    return {
        ...
        expectedDuration: formatAttendancePdfDuration(day.expectedWorkMinutes, { emptyLabel: 'Non disponible' }),
        grossDuration: formatAttendancePdfDuration(day.grossMinutes, { emptyLabel: 'Non disponible' }),
        pauseDuration: formatAttendancePdfDuration(day.pauseMinutes, { emptyLabel: 'Non disponible' }),
        netDuration: formatAttendancePdfDuration(day.netMinutes, { emptyLabel: 'Non disponible' }),
...
function toEmployeeModel(
    ...
    return {
        ...
        netDuration: employee.durations.daysWithKnownNetDuration > 0
            ? formatAttendancePdfDuration(employee.durations.netMinutes, { emptyLabel: 'Non disponible' })
            : 'Non disponible',
