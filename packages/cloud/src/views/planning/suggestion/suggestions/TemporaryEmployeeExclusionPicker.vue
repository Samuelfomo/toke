<template>
  <section class="rounded-2xl border border-slate-200 bg-white p-4 sm:p-5">
    ...
    <div class="mt-3 grid max-h-72 gap-2 overflow-y-auto pr-1 sm:max-h-none sm:grid-cols-2 sm:overflow-visible">
      <label
      ...
      <div
          ...
          class="rounded-xl border border-dashed border-slate-200 px-4 py-7 text-center text-xs text-slate-500 sm:col-span-2"
      >
