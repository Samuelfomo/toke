  ...
  <div class="flex h-full bg-slate-50 overflow-hidden">
    ...
    <transition name="panel">
      ...
      >
        ...
        <!-- Header détail -->
        <div class="bg-white border-b border-slate-200 px-4 md:px-6 py-4 flex items-center justify-between flex-shrink-0 gap-3">
        ...
        <div class="flex-1 overflow-y-auto p-4 md:p-6 flex flex-col gap-5">
              ...
              >
                ...
                <div class="flex flex-col items-center flex-shrink-0 w-7 md:w-8">
                  <div
                      ...
                      :class="idx === 0 ? 'bg-indigo-500 text-white' : 'bg-slate-100 text-slate-500'"
                  >{{ idx + 1 }}</div>
                ...
                <!-- Template card -->
                <div class="flex-1 flex items-center gap-2 md:gap-3 bg-slate-50 hover:bg-indigo-50 border border-slate-200 hover:border-indigo-200 rounded-xl px-3 md:px-4 py-2.5 transition group-hover:shadow-sm">
          ...
          <div class="md:hidden flex gap-2">
            <button
                ...
                class="flex-1 flex items-center justify-center gap-1.5 py-2.5 rounded-xl text-xs font-semibold text-indigo-600 bg-indigo-50 hover:bg-indigo-100 transition"
            >
              <IconPencil :size="13" /> Modifier
            </button>
            <button
...
<!--            : 'border-slate-200 bg-white hover:border-indigo-200 hover:bg-slate-50'"-->
<!--        >-->
<!--          &lt;!&ndash; Barre couleur gauche &ndash;&gt;-->
<!--          <div-->
<!--              class="absolute left-0 top-0 bottom-0 w-0.5 transition-all"-->
<!--              :class="selected?.guid === item.guid ? 'bg-indigo-500' : 'bg-transparent group-hover:bg-indigo-200'"-->
<!--          />-->
...
<!--      &lt;!&ndash; Pagination compacte &ndash;&gt;-->
<!--      <div class="flex items-center justify-between px-4 py-3 border-t border-slate-100 flex-shrink-0 gap-2">-->
<!--        &lt;!&ndash; Lignes par page &ndash;&gt;-->
<!--        <div class="flex items-center gap-1.5">-->
<!--          <span class="text-[10px] text-slate-400">Lignes</span>-->
<!--          <select-->
<!--              :value="pagination.limit"-->
...
<!--          </div>-->
<!--          <div class="flex items-center gap-2 flex-shrink-0">-->
<!--            &lt;!&ndash; Toggle actif/inactif &ndash;&gt;-->
<!--            <button @click="toggleActive"-->
<!--                    class="flex items-center gap-2 px-3 py-1.5 rounded-lg border text-xs font-semibold transition"-->
<!--                    :class="selected.active-->
<!--                ? 'border-emerald-200 bg-emerald-50 text-emerald-700 hover:bg-emerald-100'-->
...
<!--          &lt;!&ndash; Séquence de rotation &ndash;&gt;-->
<!--          <div class="bg-white rounded-2xl border border-slate-200 overflow-hidden">-->
...
<!--                &lt;!&ndash; Cycle indicator à la fin &ndash;&gt;-->
<!--                <div v-if="idx === (selected.cycle_templates?.length ?? 0) - 1"-->
...
<!--      &lt;!&ndash; État vide : aucun groupe sélectionné &ndash;&gt;-->
<!--      <div v-else-if="!loading && items.length > 0"-->
...
<!--    &lt;!&ndash; ══ Add position modal ══ &ndash;&gt;-->
<!--    <Teleport to="body">-->
<!--      <div v-if="showAddPosition" class="fixed inset-0 z-50 flex items-center justify-center p-4" @click.self="showAddPosition = false">-->
<!--        <div class="absolute inset-0 bg-black/30 backdrop-blur-sm" />-->
<!--        <div class="relative bg-white border border-slate-200 rounded-2xl p-6 w-full max-w-sm shadow-xl">-->
