...
class ScheduleAssignmentService {
    static listScheduleAssignments(reference, manager) {
    ...
    static saveScheduleAssignment(reference, payload) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const api = yield (0, api_factory_js_1.getApiClient)(reference);
    ...
    static updatedScheduleAssignment(reference, guid, payload) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const api = yield (0, api_factory_js_1.getApiClient)(reference);
